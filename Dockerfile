...
ENV THARSIS_INTERNAL_RUNNERS_0_NAME=system-runner-1
ENV THARSIS_INTERNAL_RUNNERS_0_JOB_DISPATCHER_TYPE=local
ENV THARSIS_INTERNAL_RUNNERS_0_JOB_DISPATCHER_DATA_API_URL=http://localhost:8000
